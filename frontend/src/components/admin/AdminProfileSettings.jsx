  ...
  return (
    <div className="min-h-screen bg-[#f0f0f0]">
      ...
      <div className="pt-[100px] px-8 max-w-3xl mx-auto">
        ...
        {isDev && (
          <pre className="bg-gray-100 p-2 rounded text-xs text-gray-700 mb-4">
          ...
          <>
            <div className="bg-[#fffbe9] rounded-xl p-8 mb-8 flex items-center gap-8 shadow">
              <div className="relative">
                <div className="w-[120px] h-[120px] rounded-full bg-[#815fb3] flex items-center justify-center">
                  <img src="/pat-removebg-preview 2.png" alt="Profile" className="w-[80px] h-[80px] object-contain" />
                </div>
                <div className="absolute bottom-2 right-2 bg-[#fff07b] rounded-full p-2 border border-[#815fb3]">
              ...
              <div>
                <div className="text-xl font-bold" style={{fontFamily: 'Raleway, sans-serif'}}>{admin.name || admin.full_name || admin.username || 'Admin User'}</div>
                ...
                <div className="flex items-center gap-2 text-[#57166b] mb-1">
                  ...
                  {admin.clinic_name || admin.clinic || 'No clinic info'}
                </div>
                <div className="flex items-center gap-2 text-[#57166b]">
                  ...
                  {admin.phone || admin.contact || 'No phone'}
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between border rounded-lg px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-[#888] ml-2">Last Updated: Never</span>
                  </div>
                ...
                <div className="flex items-center justify-between border rounded-lg px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-[#e74c3c] ml-2">Not Configured</span>
                  </div>
                  <button className="bg-[#fff07b] text-[#57166b] px-6 py-2 rounded font-bold border border-[#e5e5c3]" style={{fontFamily: 'Raleway, sans-serif'}}>Add</button>
                </div>
              </div>
            </div>
          </>
