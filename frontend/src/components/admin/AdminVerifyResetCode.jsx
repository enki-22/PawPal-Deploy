...
export default function AdminVerifyResetCode() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F7FAFC] p-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-md p-8">
        <h1 className="text-2xl font-semibold text-gray-800 mb-2">Admin - Verify Reset Code</h1>
        <p className="text-sm text-gray-600 mb-6">Send the OTP to your admin email, then enter the 6-digit code.</p>
