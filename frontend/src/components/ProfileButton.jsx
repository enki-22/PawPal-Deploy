...
const ProfileButton = () => {
  ...
  return (
    <div className="relative profile-dropdown-container">
      ...
      {/* Dropdown Menu */}
      {dropdownVisible && (
        <div className="absolute right-0 top-12 bg-[#EFE8BE] rounded-xl shadow-lg py-3 min-w-56 z-50 border border-gray-200">
          <div className="px-5 py-3 border-b border-[#D4C34A]">
          ...
          <div className="py-2">
            ...
            <button className="w-full text-left px-5 py-3 hover:bg-[#D4C34A] transition-colors flex items-center space-x-4 text-[#34113F]">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
